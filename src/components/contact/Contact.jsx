        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">Los Angeles, California, US</p>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">thomson19960313@gmail.com</p>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">+1 6058087356</p>
                </div>
            </div>
